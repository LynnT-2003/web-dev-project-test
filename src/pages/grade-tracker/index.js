						...
						{selectedGroup.subjects.map((course, j) => (
							<tr key={j}>
								...
								<td>
									...
									<button
										onClick={() => {setSelectedCourse(course.name); handleClickShowModal()}
										}
									...
									<Modal show={showModal} onHide={handleCloseModal}>
										...
										<Modal.Footer>
											<Button variant="primary" onClick={() => {handleClick(selectedCourse, course.code, course.credit, selectedSemester, selectedYear); handleCloseModal()}}>
												Done
											</Button>
										</Modal.Footer>
									</Modal>
